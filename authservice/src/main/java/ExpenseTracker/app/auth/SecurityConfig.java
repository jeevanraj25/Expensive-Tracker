package ExpenseTracker.app.auth;
...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsServiceImpl userDetailsServiceImpl(UserRepository userRepository,UserInfoProducer userInfoProducer,PasswordEncoder passwordEncoder) {
